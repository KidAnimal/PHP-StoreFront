...
require_once ROOT_PATH.'util/secure_conn.php';
require_once ROOT_PATH.'util/validation.php';

require_once ROOT_PATH.'model/cart.php';
require_once ROOT_PATH.'model/product_db.php';
require_once ROOT_PATH.'model/order_db.php';
require_once ROOT_PATH.'model/customer_db.php';
require_once ROOT_PATH.'model/address_db.php';
